...
​SQLite-net-pcl - Local Database Engine
​CommunityToolkit.Mvvm - For simplified data binding and commands
...
​.NET 8 SDK or higher.
​Installation
1. Clone the repository: git clone https://github.com/TodorTs/CarListApp.git
2. Open CarListApp.sln in Visual Studio.
3. Restore NuGet packages.
4. Select your target platform (e.g., Android Emulator or Windows Machine).
